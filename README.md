...
```bash
yarn add nova-vue3-field-helper
```
OR
```bash
npm install nova-vue3-field-helper
```

## 2. Declare globals
Create a `globals.d.ts` in the root of your javascript folder with this content: 
```typescript
import { Nova as NovaType } from '@nova-kit/nova-vue3-field-helper';
...
```typescript
import { Field, FieldProps } from '@nova-kit/nova-vue3-field-helper';
...
For example: 
```typescript
import type { EmitFn } from '@nova-kit/nova-vue3-field-helper';
...
import type { EmitFn } from '@nova-kit/nova-vue3-field-helper';
import { useFormField, useLocalization } from '@nova-kit/nova-vue3-field-helper';
